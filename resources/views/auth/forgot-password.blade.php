...
<div class="auth-page-wrapper">
    ...
    <div class="container">
        ...
        <form id="forgotPasswordForm" method="POST" action="{{ route('password.forgot.submit') }}" novalidate>
            @csrf
            ...
            if (data.success) {
                ...
                setTimeout(() => {
                    if (data.redirect_url) {
                        ...
                        window.location.href = '{{ route("password.forgot-otp") }}';
                    }
                }, 1000);
            } else {
