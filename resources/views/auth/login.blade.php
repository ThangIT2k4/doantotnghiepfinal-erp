...
<div class="auth-page-wrapper">
    ...
    <div class="container">
        ...
        <div class="auth-loading-overlay" id="loginLoadingOverlay" aria-hidden="true">
            <div class="auth-loading-card" role="status" aria-live="polite">
                <div class="auth-loading-orbit" aria-hidden="true"></div>
                <p id="loginLoadingText">Đang xử lý đăng nhập...</p>
            </div>
        </div>
        ...
        <form id="loginForm" method="POST" action="{{ route('login.store') }}" novalidate>
            ...
            <button type="submit" class="signup-btn" id="loginSubmitBtn">
                <span class="btn-loader" aria-hidden="true"></span>
                <i class="fas fa-right-to-bracket btn-icon" aria-hidden="true"></i>
                <span class="btn-text">Đăng nhập</span>
            </button>
        </form>

        <div class="footer">
            Chưa là thành viên? <a href="{{ route('register') }}">Đăng ký ngay</a>
        </div>
    </div>
</div>
...
.auth-page-wrapper #loginLoadingText {
    margin: 0;
    color: #e8f9ff;
    font-size: 0.95rem;
    font-weight: 700;
...
const LOGIN_DEFAULT_TEXT = 'Đăng nhập';
const LOGIN_LOADING_TEXT = 'Đang đăng nhập...';

function setLoginLoadingState(isLoading, message = LOGIN_LOADING_TEXT) {
    ...
    btnText.textContent = isLoading ? message : LOGIN_DEFAULT_TEXT;
}

function setLoginOverlayState(isLoading, message = 'Đang xác thực tài khoản...') {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(event) {
            ...
            setLoginOverlayState(true, 'Đang đăng nhập, vui lòng chờ...');
        });
    }
