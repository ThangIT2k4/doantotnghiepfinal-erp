...
<div class="auth-page-wrapper">
    ...
    <div class="container">
        <div class="header">
            <h1>Đăng ký</h1>
            <p>Tham gia cộng đồng ngay hôm nay!</p>
        </div>

        <div class="register-steps" aria-label="Tiến trình đăng ký">
            <div class="register-step register-step--active">
                <span class="register-step-num">1</span>
                <span class="register-step-label">Thông tin &amp; tạo tổ chức</span>
            </div>
        </div>
        <p class="register-step-hint">Điền form bên dưới — sau khi gửi, bạn sẽ được đăng nhập và chuyển vào hệ thống.</p>
        ...
        <div class="footer">
            Đã là thành viên? <a href="{{ route('login') }}">Đăng nhập</a>
        </div>
    </div>
</div>
...
.auth-page-wrapper .register-steps {
    display: flex;
    align-items: center;
    justify-content: center;
    gap: 10px;
...
.auth-page-wrapper .register-step {
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 8px 14px;
...
.auth-page-wrapper .register-step--active {
    border-color: rgba(77, 247, 199, 0.55);
    background: rgba(77, 247, 199, 0.12);
    color: var(--text-main);
}

.auth-page-wrapper .register-step-num {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    width: 22px;
...
.auth-page-wrapper .register-step--active .register-step-num {
    background: rgba(77, 247, 199, 0.35);
}

.auth-page-wrapper .register-step-divider {
    width: 28px;
    height: 2px;
    border-radius: 2px;
    background: linear-gradient(90deg, rgba(64, 219, 255, 0.2), rgba(77, 247, 199, 0.65));
    opacity: 0.85;
}

.auth-page-wrapper .register-step-hint {
    text-align: center;
    color: var(--text-muted);
    font-size: 0.85rem;
    line-height: 1.45;
