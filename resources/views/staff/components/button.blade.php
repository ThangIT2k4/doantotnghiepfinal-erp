...
.table .btn-group .btn-icon-only:hover,
.table .btn-group a.btn:hover,
.table .btn-group .btn:focus,
.table .btn-group .btn-icon-only:focus,
.table .btn-group a.btn:focus,
.table .btn-group .btn:active,
.table .btn-group .btn-icon-only:active,
.table .btn-group a.btn:active {
    border: none !important;
    text-decoration: none !important;
}
