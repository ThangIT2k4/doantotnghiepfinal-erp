...
<main class="main-content">
    <div class="container-fluid">
        ...
        @include('staff.components.index-page-header', [
            'title' => 'Tạo Chính sách Hoa hồng',
            'subtitle' => 'Thiết lập chính sách hoa hồng mới cho nhân viên',
        ...
        <form id="create-commission-policy-form" method="POST" action="{{ route('staff.commission-policies.store') }}">
            @csrf
            <div class="row">
                <!-- Basic Information -->
                <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3" id="flat_amount_field" style="display: none;">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="flat_amount" 
                                           name="flat_amount" 
                                           value="{{ old('flat_amount') ? number_format(old('flat_amount'), 0, ',', '.') : '' }}" 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="min_amount" 
                                           name="min_amount" 
                                           value="{{ old('min_amount') ? number_format(old('min_amount'), 0, ',', '.') : '' }}" 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="cap_amount" 
                                           name="cap_amount" 
                                           value="{{ old('cap_amount') ? number_format(old('cap_amount'), 0, ',', '.') : '' }}" 
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0 small">
                                    <li>Mã chính sách và tên chính sách là bắt buộc</li>
                                    <li>Mã chính sách phải là duy nhất</li>
                                    <li>Chọn loại tính toán phù hợp (Phần trăm, Số tiền cố định, hoặc Bậc thang)</li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('create-commission-policy-form');
    if (form) {
