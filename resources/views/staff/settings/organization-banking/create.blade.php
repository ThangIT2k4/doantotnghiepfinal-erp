...
<main class="main-content">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">
                    <i class="fas fa-plus-circle me-2"></i>Thêm tài khoản ngân hàng
                </h1>
                <p class="text-muted mb-0">Thêm thông tin tài khoản ngân hàng mới</p>
            </div>
            <div>
                        ...
                        <form id="bankingAccountForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="account_number" name="account_number" 
                                       placeholder="VD: 46166378666" required>
                                <div class="invalid-feedback"></div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="account_name" name="account_name" 
                                       placeholder="VD: Le Xuan Thanh Quan" required>
                                <div class="invalid-feedback"></div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="3" 
                                          placeholder="Ghi chú về tài khoản ngân hàng (tùy chọn)"></textarea>
                                <div class="invalid-feedback"></div>
                            </div>
...
document.getElementById('bankingAccountForm').addEventListener('submit', function(e) {
    ...
    // Submit
    fetch('{{ route("staff.organization-banking.store") }}', {
        method: 'POST',
        headers: {
